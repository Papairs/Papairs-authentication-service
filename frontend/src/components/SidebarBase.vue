...
<template>
    <div class="flex flex-col w-[280px] bg-white border-r border-gray-200 h-screen">
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <button 
                ...
                class="flex items-center justify-center gap-2 px-4 py-3 mb-4 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
            >
                <span class="text-lg font-semibold text-gray-700">New</span>
            ...
            <div v-if="isDriveView">
                <!-- My papairs Section -->
                <div class="mt-4 mb-2">
                    <h2 class="text-xs font-semibold text-gray-600 px-2">My papairs</h2>
                </div>
                ...
                <!-- Shared with me -->
                <a href="/drive/shared" class="flex gap-3 items-center px-2 py-2 hover:bg-gray-100 rounded">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span class="text-base text-gray-700">Shared with me</span>
                </a>
                
                <!-- Favorites -->
                <button class="flex gap-3 items-center px-2 py-2 hover:bg-gray-100 rounded cursor-pointer">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                    </svg>
                    <span class="text-base text-gray-700">Favorites</span>
                </button>
            </div>
        ...
        <div class="border-t border-gray-200 px-3 py-3">
            <div class="flex flex-col gap-1">
                ...
                <button class="flex gap-3 items-center px-2 py-2 hover:bg-gray-100 rounded cursor-pointer">
                    ...
                    <span class="text-base text-gray-700">Settings</span>
                </button>
                
                <!-- Dark Mode -->
                <button @click="toggleTheme" class="flex gap-3 items-center px-2 py-2 hover:bg-gray-100 rounded cursor-pointer">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                    </svg>
                    <span class="text-base text-gray-700">Dark Mode</span>
                </button>
                ...
                <button class="flex gap-3 items-center px-2 py-2 hover:bg-gray-100 rounded cursor-pointer">
                    ...
                    <span class="text-base text-gray-700">Trash</span>
                </button>
            </div>
